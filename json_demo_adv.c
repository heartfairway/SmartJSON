...
int main(void)
{
	...
	/* source JSON string */
	strcpy(buf_a, "{\"nameA\":{\"AA\":[\"s1\", \"s2\", \"s3\" ], \"AB\":[\"s4\", \"s5\", \"s6\" ], \"AC\":[\"s7\", \"s8\", \"s9\"]}, \"nameB\":{\"BA\":[\"s10\", \"s11\", \"s12\"], \"BB\":[\"s13\",\"s14\",\"s15\"],\"BC\":[\"s16\", \"s17\", \"s18\" ]}, \"nameC\":{\"CA\":[\"s19\", \"s20\", \"s21\" ], \"CB\":[\"s22\", \"s23\", \"s24\" ], \"CC\":[\"s25\", \"s26\", \"s27\" ]} }"); // mixed object
